...
- Công cụ này viết chủ yếu bằng ngôn ngữ C++, tập trung vào năng suất. C-fetch chỉ hỗ trợ hệ điều hành Windows.
- Hiện tại C-fetch còn nhiều hạn chế về ngôn ngữ, thông tin máy, và nhiều hệ điều hành khác. Chúng tôi sẽ cố gắng ra bản nâng cấp sớm nhất.   
...
## Chương trình khi bạn cài thành công 
